...
# Of the 78% of respondents that indicated they'd like to have immigrants as neighbors, 40% of respondents agreed with the statement, "immigration increases the risk of terrorism." This group, comprising 18% of the total respondents included in the tree is not comprehensive as NAs were omitted for analysis. However, it is still an interesting finding that 18% of those responses included hold a somewhat contradictory set of beliefs; immigrants increase risk of terrorism, but they don't voice a hesitancy to have immigrants as neighbors. 
