...
##### Based on my classification system, respondents fall into the following categories regarding immigration viewpoints: 27% oare very supportive, 44% are somewhat supportive, 18% are neutral or unsure, and 12% are not supportive.
...
# stuck here for now, will continue later
