...
# tree plotting
library(rpart)
equation = Tolerance.Important.For.Children~Immigrants.As.Neighbors+Immigration.Increases.Terrorism.Risk

tolerance_tree <- rpart(formula = equation, 
                 data = train,
                 method = 'class',
                minsplit=2,
                cp=-1,
...
library(rattle)
library(rpart.plot)
rpart.plot(tolerance_tree, box.palette="BlGnYl")
fancyRpartPlot(tolerance_tree, caption = "Health")
