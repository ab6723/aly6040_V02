...
Our firm was contacted by the WVS and asked to complete a comprehensive data mining project using the latest available data. Our team was tasked with extracting deeper meaning from the data, and beginning to unlock answers to key questions related to some of the most timely conversations around values. These include but are not limited to immigration, religion, and LGBT acceptance. 
